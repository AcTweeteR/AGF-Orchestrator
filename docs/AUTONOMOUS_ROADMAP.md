...
E5 is complete through E5-T3 and PR #61. E6-T1 is complete through merged
PR #65, with its required evidence retained in the AGF state store. The
following bounded tasks decompose only the approved E6 scope. Task state is
explicit: E6-T2 is the next `READY` task; every later task remains `PLANNED`
until all listed dependencies complete with their required evidence. No task
...
- E5 is complete through E5-T3 and PR #61. E6-T1 is complete through PR
  #65, and the next approved executable task is E6-T2, which is `READY`;
  E6-T3 through E6-T8 remain `PLANNED`.
